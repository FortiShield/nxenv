...
```shell
NXENV_VERSION=... ERPNEXT_VERSION=... docker buildx bake <targets>
```
...
# Nxenv and ERPNext updates

Each Nxenv/ERPNext release triggers new stable images builds as well as bump to helm chart.
...
- `images/nxcli/Dockerfile`: Change the files to use new debian release. Make sure apt-get packages and wkhtmltopdf version are also upgraded accordingly.
