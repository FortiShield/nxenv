...
class DocTypeLayout(Document):
	...
	if TYPE_CHECKING:
		from nxenv.custom.doctype.doctype_layout_field.doctype_layout_field import DocTypeLayoutField
	...
	def sync_fields(self):
		doctype_fields = nxenv.get_meta(self.document_type, cached=False).fields
