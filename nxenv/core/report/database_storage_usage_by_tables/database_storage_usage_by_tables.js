...
nxenv.query_reports["Database Storage Usage By Tables"] = {
	filters: [],
			...
			function () {
				let d = new nxenv.ui.Dialog({
					...
					primary_action(values) {
						nxenv.call({
							method: "nxenv.core.report.database_storage_usage_by_tables.database_storage_usage_by_tables.optimize_doctype",
							args: {
