...
from nxenv.utils import cint, convert_utc_to_system_timezone
from nxenv.utils.background_jobs import get_workers
...
def serialize_worker(worker: Worker) -> nxenv._dict:
	...
	if current_job and not current_job.startswith(nxenv.local.site):
		current_job = None
