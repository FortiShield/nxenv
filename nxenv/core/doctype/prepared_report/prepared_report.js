...
nxenv.ui.form.on("Prepared Report", {
	...
	refresh: function (frm) {
		...
		if (frm.doc.status == "Completed") {
			frm.page.set_primary_action(__("Show Report"), () => {
				nxenv.route_options = { prepared_report_name: frm.doc.name };
				nxenv.set_route("query-report", frm.doc.report_name);
			});
		}
	},
});
