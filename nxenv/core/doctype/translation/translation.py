...
from nxenv.translate import MERGED_TRANSLATION_KEY, USER_TRANSLATION_KEY
...
def clear_user_translation_cache(lang):
	nxenv.cache.hdel(USER_TRANSLATION_KEY, lang)
	nxenv.cache.hdel(MERGED_TRANSLATION_KEY, lang)
