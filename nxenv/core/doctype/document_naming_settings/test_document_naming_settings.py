...
from nxenv.core.doctype.document_naming_settings.document_naming_settings import (
	DocumentNamingSettings,
)
from nxenv.model.naming import NamingSeries, get_default_naming_series
...
class TestNamingSeries(IntegrationTestCase):
	...
	def setUp(self):
		self.dns: DocumentNamingSettings = nxenv.get_doc("Document Naming Settings")
	...
	def test_get_transactions(self):
		...
		existing_naming_series = nxenv.get_meta(self.ns_doctype).get_field("naming_series").options
	...
	def test_updates_naming_options(self):
		...
		self.assertIn(test_series, nxenv.get_meta(self.ns_doctype).get_naming_series_options())
