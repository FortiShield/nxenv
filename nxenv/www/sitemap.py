...
from nxenv.utils import get_url, nowdate
from nxenv.utils.caching import redis_cache
from nxenv.website.router import get_doctypes_with_web_view, get_pages
...
def get_public_pages_from_doctypes():
	...
	if robots_txt := nxenv.db.get_single_value("Website Settings", "robots_txt"):
