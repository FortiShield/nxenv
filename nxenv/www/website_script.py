...
def get_context(context):
	context.javascript = nxenv.db.get_single_value("Website Script", "javascript") or ""
...
def get_setting(field_name):
	...
	website_settings = nxenv.db.get_single_value("Website Settings", field_name)
	conf = nxenv.conf.get(field_name)
