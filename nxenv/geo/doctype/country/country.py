...
import nxenv
from nxenv import _
from nxenv.model.document import Document, bulk_insert
...
def get_countries_and_currencies():
	from nxenv.geo.country_info import get_all as get_geo_data
