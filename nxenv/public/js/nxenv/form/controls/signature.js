nxenv.ui.form.ControlSignature = class ControlSignature extends nxenv.ui.form.ControlData {
	make() {
		var me = this;
		this.saving = false;
		this.loading = false;
		...
		nxenv.require("/assets/nxenv/js/lib/jSignature.min.js").then(() => {
		...
		this.img_wrapper = $(`<div class="signature-display">
			<div class="missing-image attach-missing-image">
				${nxenv.utils.icon("restriction", "md")}</i>
