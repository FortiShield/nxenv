nxenv.ui.form.ControlFloat = class ControlFloat extends nxenv.ui.form.ControlInt {
	parse(value) {
	...
	get_number_format() {
		var currency = nxenv.meta.get_field_currency(this.df, this.get_doc());
		return get_number_format(currency);
	}

	get_precision() {
		// round based on field precision or float precision, else don't round
		return this.df.precision || cint(nxenv.boot.sysdefaults.float_precision, null);
	}
};

nxenv.ui.form.ControlPercent = nxenv.ui.form.ControlFloat;
