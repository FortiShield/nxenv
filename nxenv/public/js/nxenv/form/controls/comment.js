...
nxenv.ui.form.ControlComment = class ControlComment extends nxenv.ui.form.ControlTextEditor {
	make_wrapper() {
		this.comment_wrapper = !this.no_wrapper
			...
			<div class="comment-input-wrapper">
				...
				${nxenv.avatar(nxenv.session.user, "avatar-medium")}
					<div class="nxenv-control col"></div>
				</div>
		...
		`)
			: $('<div class="nxenv-control"></div>');

		this.comment_wrapper.appendTo(this.parent);

		// wrapper should point to nxenv-control
		this.$wrapper = !this.no_wrapper
			? this.comment_wrapper.find(".nxenv-control")
