...
nxenv.views.Container = class Container {
	...
	change_to(label) {
		...
		this.page._route = nxenv.router.get_sub_path();
		$(this.page).trigger("show");
		!this.page.disable_scroll_to_top && nxenv.utils.scroll_to(0);
	...
	has_sidebar() {
		var flag = 0;
		var route_str = nxenv.get_route_str();
		// check in nxenv.ui.pages
		flag = nxenv.ui.pages[route_str] && !nxenv.ui.pages[route_str].single_column;

		// sometimes nxenv.ui.pages is updated later,
