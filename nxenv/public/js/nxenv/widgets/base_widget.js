...
export default class Widget {
	...
	customize(options) {
		...
		options.allow_sorting &&
			nxenv.utils.add_custom_button(
				nxenv.utils.icon("es-line-drag", "xs"),
				null,
				"drag-handle",
				__("Drag"),
				null,
		...
		options.allow_edit &&
			nxenv.utils.add_custom_button(
				nxenv.utils.icon("es-line-edit-alt", "xs"),
				() => this.edit(),
				"edit-button",
				__("Edit"),
				null,
	...
	set_title(max_chars) {
		...
		let title = max_chars ? nxenv.ellipsis(base, max_chars) : base;
