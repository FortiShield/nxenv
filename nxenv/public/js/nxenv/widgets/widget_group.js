...
nxenv.provide("nxenv.widget");

nxenv.widget.widget_factory = {
	chart: ChartWidget,
	base: BaseWidget,
...
nxenv.widget.make_widget = (opts) => {
	const widget_class = nxenv.widget.widget_factory[opts.widget_type];
	if (widget_class) {
...
export default class WidgetGroup {
	...
	add_widget(widget) {
		let widget_object = nxenv.widget.make_widget({
			...widget,
...
nxenv.widget.WidgetGroup = WidgetGroup;
nxenv.widget.SingleWidgetGroup = SingleWidgetGroup;
