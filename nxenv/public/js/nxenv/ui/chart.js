import { Chart } from "nxenv-charts/dist/nxenv-charts.esm";

nxenv.provide("nxenv.ui");
nxenv.Chart = Chart;

nxenv.ui.RealtimeChart = class RealtimeChart extends nxenv.Chart {
	constructor(element, socketEvent, maxLabelPoints = 8, data) {
		...
		this.start_updating = function () {
			nxenv.realtime.on(this.socketEvent, (data) => {
				this.update_chart(data.label, data.points);
			});
		};

		this.stop_updating = function () {
			nxenv.realtime.off(this.socketEvent);
		};
