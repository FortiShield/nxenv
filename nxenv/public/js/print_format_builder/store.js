...
export function getStore(print_format_name) {
	...
	function fetch() {
		return new Promise((resolve) => {
			nxenv.model.clear_doc("Print Format", print_format_name);
			nxenv.model.with_doc("Print Format", print_format_name, () => {
				let _print_format = nxenv.get_doc("Print Format", print_format_name);
				nxenv.model.with_doctype(_print_format.doc_type, () => {
					meta.value = nxenv.get_meta(_print_format.doc_type);
	...
	function change_letterhead(_letterhead) {
		return nxenv.db.get_doc("Letter Head", _letterhead).then((doc) => {
