...
Use `nxenv.utils.synchroniztion.filelock` for process synchroniztion.
"""
...
import nxenv
from nxenv.utils import get_site_path, touch_file
...
def release_document_locks():
	...
	for doc in nxenv.local.locked_documents:
		doc.unlock()
