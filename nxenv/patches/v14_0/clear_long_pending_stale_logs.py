import nxenv
from nxenv.core.doctype.log_settings.log_settings import clear_log_table
from nxenv.utils import add_to_date, today
...
def execute():
	...
	ref: https://github.com/nxenv/nxenv/issues/16971
	"""
...
def is_log_cleanup_stuck(doctype: str, retention: int) -> bool:
	...
	return bool(nxenv.db.exists(doctype, {"modified": ("<", threshold)}))


def get_current_setting(fieldname):
	try:
		return nxenv.db.get_single_value("Log Settings", fieldname)
	except Exception:
