import nxenv
from nxenv.desk.doctype.notification_log.notification_log import make_notification_logs


def execute():
	if nxenv.get_all("Email Account", {"auth_method": "OAuth", "connected_user": ["is", "set"]}, limit=1):
		return
	...
	nxenv.db.set_value("Email Account", {"auth_method": "OAuth"}, "awaiting_password", 1)
...
def get_system_managers():
	user_doctype = nxenv.qb.DocType("User").as_("user")
	user_role_doctype = nxenv.qb.DocType("Has Role").as_("user_role")
	return (
