...
from nxenv.twofactor import PARENT_FOR_DEFAULTS
from nxenv.utils.password import encrypt
...
def execute():
	...
	secrets = {
		key: value
		for key, value in nxenv.defaults.get_defaults_for(parent=OLD_PARENT).items()
	...
	defvalue_cases = nxenv.qb.terms.Case()
