...
from nxenv.utils import cint, cstr, get_datetime, get_system_timezone
...
class TokenCache(Document):
	...
	def get_auth_header(self):
		...
		raise nxenv.exceptions.DoesNotExistError
	...
	def update_data(self, data):
		...
		if token_type not in ["bearer", "mac"]:
			nxenv.throw(_("Received an invalid token type."))
		# 'Bearer' or 'MAC'
