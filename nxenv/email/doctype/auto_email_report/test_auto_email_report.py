...
from nxenv.utils import add_to_date, get_link_to_form, today
from nxenv.utils.data import is_html
...
class TestAutoEmailReport(IntegrationTestCase):
	def test_auto_email(self):
		nxenv.delete_doc("Auto Email Report", "Permitted Documents For User")
...
def get_auto_email_report():
	if not nxenv.db.exists("Auto Email Report", "Permitted Documents For User"):
		auto_email_report = nxenv.get_doc(
		...
		auto_email_report = nxenv.get_doc("Auto Email Report", "Permitted Documents For User")
