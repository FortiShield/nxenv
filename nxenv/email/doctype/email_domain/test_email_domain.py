...
class TestDomain(IntegrationTestCase):
	...
	def tearDown(self):
		nxenv.delete_doc("Email Account", "Test")
		nxenv.delete_doc("Email Domain", "test.com")

	def test_on_update(self):
		mail_domain = nxenv.get_doc("Email Domain", "test.com")
		mail_account = nxenv.get_doc("Email Account", "Test")
