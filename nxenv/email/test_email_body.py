...
import nxenv
from nxenv import safe_decode
from nxenv.email.doctype.email_queue.email_queue import QueueBuilder, SendMailContext
from nxenv.email.email_body import (
	get_email,
	get_header,
	inline_style_in_html,
	replace_filename_with_cid,
)
from nxenv.email.receive import Email
...
<div>
	...
	<img embed="assets/nxenv/images/nxenv-favicon.svg" />
</div>
"""
		email_text = """
Hey John Doe!
...
"""
		...
		img_path = os.path.abspath("assets/nxenv/images/nxenv-favicon.svg")
	...
	def test_prepare_message_returns_already_encoded_string(self):
		...
		queue_doc = nxenv.get_last_doc("Email Queue")
...
Content-Disposition: inline; filename="nxenv-favicon.svg"
"""
...
"""
	...
	def test_replace_filename_with_cid(self):
		original_message = """
			<div>
				<img embed="assets/nxenv/images/nxenv-favicon.svg" alt="test" />
