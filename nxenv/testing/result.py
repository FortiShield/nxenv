...
to provide custom formatting and logging for test results in the Nxenv framework.
...
test results during test execution in the Nxenv framework.
"""
...
class TestResult(unittest.TextTestResult):
	...
	def startTestRun(self):
		if not sys.warnoptions:
			...
			from nxenv.deprecation_dumpster import NxenvDeprecationWarning

			warnings.simplefilter("ignore")
			warnings.filterwarnings("module", category=NxenvDeprecationWarning)
