...
import nxenv
from nxenv.query_builder import Interval, Order
from nxenv.query_builder.functions import Date, Sum, UnixTimestamp
...
def get_energy_points_heatmap_data(user, date):
	...
	eps_log = nxenv.qb.DocType("Energy Point Log")

	return dict(
		nxenv.qb.from_(eps_log)
...
def update_profile_info(profile_info):
	profile_info = nxenv.parse_json(profile_info)
