...
class ModuleOnboarding(Document):
	...
	if TYPE_CHECKING:
		from nxenv.desk.doctype.onboarding_permission.onboarding_permission import OnboardingPermission
		from nxenv.desk.doctype.onboarding_step_map.onboarding_step_map import OnboardingStepMap
	...
	def get_steps(self):
		return [nxenv.get_doc("Onboarding Step", step.step) for step in self.steps]
	...
	def reset_progress(self):
		...
		nxenv.msgprint(_("Module onboarding progress reset"), alert=True)
