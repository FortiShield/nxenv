# Copyright (c) 2015, Nxenv Technologies Pvt. Ltd. and Contributors and Contributors
...
class TestNote(IntegrationTestCase):
	def insert_note(self):
		nxenv.db.delete("Version")
		nxenv.db.delete("Note")
		nxenv.db.delete("Note Seen By")

		return nxenv.get_doc(doctype="Note", title="test note", content="test note content").insert()
	...
	def test_version(self):
		...
		version = nxenv.get_doc("Version", dict(docname=note.name))
