...
class TestWorkspace(IntegrationTestCase):
	...
	def tearDown(self):
		nxenv.db.delete("Workspace", {"module": "Test Module"})
		nxenv.db.delete("DocType", {"module": "Test Module"})
		nxenv.delete_doc("Module Def", "Test Module")
	...
	# 	if nxenv.get_system_settings('country') == "France":
...
def create_module(module_name):
	module = nxenv.get_doc({"doctype": "Module Def", "module_name": module_name, "app_name": "nxenv"})
...
def create_workspace(**args):
	workspace = nxenv.new_doc("Workspace")
