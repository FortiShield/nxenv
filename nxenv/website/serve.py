...
from nxenv.website.page_renderers.not_permitted_page import NotPermittedPage
...
def get_response(path=None, http_status_code=200) -> Response:
	...
	response = None
	path = path or nxenv.local.request.path
	endpoint = path
