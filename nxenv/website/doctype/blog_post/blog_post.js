// Copyright (c) 2016, Nxenv Technologies Pvt. Ltd. and contributors
// For license information, please see license.txt

nxenv.ui.form.on("Blog Post", {
	refresh: function (frm) {
		nxenv.db.get_single_value("Blog Settings", "show_cta_in_blog").then((value) => {
