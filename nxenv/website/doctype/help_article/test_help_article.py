...
class TestHelpArticle(IntegrationTestCase):
	...
	def setUpClass(cls) -> None:
		cls.help_category = nxenv.get_doc(
			{
		...
		cls.help_article = nxenv.get_doc(
			{
	...
	def test_article_is_helpful(self):
		from nxenv.website.doctype.help_article.help_article import add_feedback
	...
	def tearDownClass(cls) -> None:
		nxenv.delete_doc(cls.help_article.doctype, cls.help_article.name)
		nxenv.delete_doc(cls.help_category.doctype, cls.help_category.name)
