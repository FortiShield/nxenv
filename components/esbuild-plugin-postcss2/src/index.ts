...
import {
  Exception as SassException, // Fixed import for SassException
...
// Ensure tmp directories are cleaned up
...
function renderSass(options: SassOptions<'sync'>): Promise<SassResult> {
