...
function makeHoriLine(y, label, x1, x2, options = {}) {
	...
	let className =
		"line-horizontal " + options.className + (options.lineType === "dashed" ? "dashed" : "");
...
export function generateAxisLabel(options) {
	...
	const y2 =
		options.position === "left" ? FONT_SIZE - LABEL_WIDTH : FONT_SIZE + LABEL_WIDTH * -1;

	const rotation = options.position === "right" ? `rotate(90)` : `rotate(270)`;
