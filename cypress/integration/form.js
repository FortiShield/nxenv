...
context("Form", () => {
	before(() => {
		...
		return cy
			...
			.its("nxenv")
			.then((nxenv) => {
				return nxenv.call("nxenv.tests.ui_test_helpers.create_contact_records");
			});
	});
	...
	it("create a new form", () => {
		...
		cy.intercept({
			method: "POST",
			url: "api/method/nxenv.desk.form.save.savedocs",
		}).as("form_save");
	...
	it("validates behaviour of Data options validations in child table", () => {
		...
		cy.get('.nxenv-control[data-fieldname="email_ids"]').as("table");
