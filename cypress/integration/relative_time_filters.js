...
// 		cy.window().its('nxenv').then(nxenv => {
// 			nxenv.call("nxenv.tests.ui_test_helpers.create_todo_records");
// 		});
// 	});
...
// 		cy.intercept('POST', '/api/method/nxenv.desk.reportview.get').as('list_refresh');
...
// 		cy.intercept('POST', '/api/method/nxenv.model.utils.user_settings.save')
